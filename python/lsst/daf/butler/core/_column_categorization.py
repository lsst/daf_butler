...
from ._column_tags import ColumnTag, DimensionKeyColumnTag, DimensionRecordColumnTag, DatasetColumnTag
...
class ColumnCategorization:
    ...
    @classmethod
    def from_iterable(cls, iterable: Iterable[ColumnTag]) -> ColumnCategorization:
        result = cls()
        for tag in iterable:
            match tag:
