...
__all__ = ("setupDimensionStorage", "DimensionRecordStorage",
           "DatabaseDimensionRecordStorage", "CachingDimensionRecordStorage")
...
class DatabaseDimensionRecordStorage(DimensionRecordStorage):
    ...
    def __init__(self, connection: Connection, element: DimensionElement, *,
                 ...
                 commonSkyPixOverlapTable: Optional[FromClause]):
