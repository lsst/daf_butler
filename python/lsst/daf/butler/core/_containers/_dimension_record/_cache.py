...
from .._data_coordinate import DataCoordinateIterable, ScalarDataCoordinateSet
...
class HeterogeneousDimensionRecordCache(HeterogeneousDimensionRecordAbstractSet):
    ...
    __slots__ = ("_universe", "_by_definition",)
...
class _ByDataIdDict(DefaultDict[DataCoordinate, DimensionRecord]):
    ...
    *args, **kwargs
    ...
    def __missing__(self, key: Any) -> DimensionRecord:
        ...
        records = self._callback(ScalarDataCoordinateSet(key))
        try:
            (record,) = records
        except ValueError:
...
class HomogeneousDimensionRecordCache(HomogeneousDimensionRecordAbstractSet):
    ...
    def extract(self, data_ids: DataCoordinateIterable) -> HomogeneousDimensionRecordCache:
        # Docstring inherited.
