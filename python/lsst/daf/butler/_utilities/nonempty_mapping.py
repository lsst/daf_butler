...
class NonemptyMapping(Mapping[_K, _V]):
    ...
    any that evaluate to `False` as not present.
    ...
    that the value type will be a mutable container like `set` or `dict`, and
    that an empty nested container should be considered equivalent to the
    absence of a key.
    """
