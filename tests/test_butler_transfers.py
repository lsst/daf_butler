...
@pytest.mark.parametrize("datastore_type", ["posix", "chained"], indirect=True)
def test_absolute_u_r_i_transfer_direct(tr: TransferHarness) -> None:
    """Test transfer using an absolute URI."""
    _absolute_transfer(tr, "auto")


@pytest.mark.parametrize("datastore_type", ["posix", "chained"], indirect=True)
def test_absolute_u_r_i_transfer_unsafe_direct(tr: TransferHarness) -> None:
    """Test transfer using an absolute URI."""
    _absolute_transfer(tr, "unsafe_direct")


@pytest.mark.parametrize("datastore_type", ["posix", "chained"], indirect=True)
def test_absolute_u_r_i_transfer_copy(tr: TransferHarness) -> None:
    """Test transfer using an absolute URI."""
